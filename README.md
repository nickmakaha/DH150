...
## Methodology
Data for this project is sourced from the World Happiness Report 2022, the World Health Organization, various governmental organizations, and academic articles from humanitarian-focused writers. The high-level overview involves comparing key metrics such as social support, economic stability, and health indices between the happiest and least happy country. The true analysis, however, occurs in the magnification of the lower level social and humanitarian networks within each country, seeking the underlying infrastructures that may explain the varying happiness scores. To do this, the project aims to explore fundamental support networks within each country through the lens of a citizen and a small business owner. By comparing and contrasting the differences for each of these entitites between the countries, insights can be made into what may be contributing to overall happiness scores. Furthermore, a dive into each country's political system will give even more insight into reasons for the possible disparity between the two country's happiness scores.
...
##### Retirement Benefits
Finland has shown a strong commitment to supporting its elderly population, as reflected in its universal retirement benefits - managed by Kela and other pension institutions. Their system guarantees that all citizens have access to financial security in their old age - promoting independence and financial freedom in their older population. This could be a major contributor to the overall happiness score for Finland, as individuals will likely have higher feelings of freedom to make life decisions with financial security later in life. Additionally, by having a universal retirement benefits system, there is a lack of possible class disparity and ethnic disparity for those retiring. The presence of nodes related to these universal retirement benefits highlights the importance of these services in the Finnish social fabric, and as a consequence the country's overall happiness score.
